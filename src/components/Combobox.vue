    ...
    data() {
      return {
        ...
        people: [
          ...
          { id: 22, name: 'Rich Bregalda'},
          { id: 23, name: 'Tom Riddle' },
          { id: 24, name: 'Hermione Grentcher' },
          { id: 25, name: 'Rooney Whisley' },
          { id: 26, name: 'Madame Nora' },
          { id: 27, name: 'Hegred Phillips' },
          { id: 28, name: 'Alvo Dumbledoore' },
          { id: 29, name: 'Draco Malfoy' },
